...
namespace MyApp
{
    public partial class _102_f : Form,FormFather
    {
        /*
       * 查询数据块-
       */
        ...
        */
        ...
        private string DB_table_name = "1sbzcsq2"; 
         public  object text_a0;//传A0的值
         private  string FormId="102";
            //数据库链接
        ...
        Control.CheckForIllegalCrossThreadCalls = false;
           ...
           MyAd = new OleDbDataAdapter("select *  from "+DB_table_name+" ", MyConn);
            ...
            Directory.CreateDirectory(".\\"+main.companyName+"\\wjgl\\102");

            /*
             *数据返回器赋给当前form地址 *
             */
            main.text_19 = this.a15;
            main.text_20 = this.a16;
            main.text_21 = this.a17;
            main.text_22 = this.a18;
        ...
        private void _102_f_Load(object sender, EventArgs e)
        {
            this.Left = (int)((Screen.PrimaryScreen.Bounds.Width - this.Width) / 2);
            this.Top = (int)((Screen.PrimaryScreen.Bounds.Height - this.Height) / 2);
           
            a12.Text = DateTime.Now.ToShortDateString();
       ...
       //     a10.Text = null;
           ...
           //     MessageBox.Show("run");
                if (this.a0.Text == MyData.Tables[0].Rows[v][0].ToString())
                {
                    ...
                    break;
                       ...
                       panel2.Enabled = true;
                    int a10_1_a = 0, a10_2_a = 0, a10_3_a = 0, a10_4_a = 0, a10_5_a = 0, a10_6_a = 0;
                    if (a10_1.CheckState == CheckState.Checked)
                        a10_1_a = 1;
                    if (a10_2.CheckState == CheckState.Checked)
                        a10_2_a = 1;
                    if (a10_3.CheckState == CheckState.Checked)
                        a10_3_a = 1;
                    if (a10_4.CheckState == CheckState.Checked)
                        a10_4_a = 1;
                    if (a10_5.CheckState == CheckState.Checked)
                        a10_5_a = 1;
                    if (a10_6.CheckState == CheckState.Checked)
                        a10_6_a = 1;
              ...
              Thread MySaveS = new Thread(new ThreadStart(save));
                    ...
                    NewRow["a10"] = a10_1_a.ToString() + a10_2_a.ToString() + a10_3_a.ToString() + a10_4_a.ToString() + a10_5_a.ToString() + a10_6_a.ToString();
                    NewRow["a11"] = a11.Text;
                    NewRow["a12"] = a12.Text;
                    NewRow["a13"] = a13.Text;
                    NewRow["a14"] = a14.Text;
        ...
        private void save()
        {
            ...
            Directory.CreateDirectory(".\\"+main.companyName+"\\wjgl\\102\\" + a0.Text + "");

            string temp = System.IO.Directory.GetCurrentDirectory();// d当前运行路径

            //    MessageBox.Show(temp);
            string OrignFile;//模板路径
            OrignFile = "\\baseDB\\商标书式\\1 注册申请\\02 商标注册申请书_台湾.dot";
            ...
            object aa = temp + "\\"+main.companyName+"\\wjgl\\102\\" + a0.Text + "\\" + a0.Text + ".docx";

            object[] MyBM = new object[25];//创建一个书签数组
            ...
            if (a10_2_a == 1)
                ...
                xx = " ";
            doc.Bookmarks.get_Item(ref MyBM[10]).Range.Text = xx;
            if (a10_3_a == 1)
            ...
            doc.Bookmarks.get_Item(ref MyBM[17]).Range.Text = a12.Text;
            doc.Bookmarks.get_Item(ref MyBM[18]).Range.Text = a13.Text;
            doc.Bookmarks.get_Item(ref MyBM[19]).Range.Text = a14.Text;
        
            doc.Bookmarks.get_Item(ref MyBM[20]).Range.Text = a15.Text;
            doc.Bookmarks.get_Item(ref MyBM[21]).Range.Text = a16.Text;
            doc.Bookmarks.get_Item(ref MyBM[22]).Range.Text = a17.Text;
            doc.Bookmarks.get_Item(ref MyBM[23]).Range.Text = a18.Text;
            doc.Bookmarks.get_Item(ref MyBM[24]).Range.Text = a19.Text;
        ...
        {
            Process.Start(".\\"+main.companyName+"\\wjgl\\102");
        }
      ...
      public  void CleanApp()
        {
            ...
            // int a =;// 数据库删除
            string SQL = "delete * from "+DB_table_name+" where a0='" + ((TextBoxX)text_a0).Text + "'";
            ...
            if (File.Exists(@".\\" + main.companyName + "\\wjgl\\102\\" + ((TextBox)text_a0).Text + "\\" + ((TextBox)text_a0).Text + ".docx"))
            {
                // MessageBox.Show("存在文件");
                File.Delete(@".\\" + main.companyName + "\\wjgl\\102\\" + ((TextBox)text_a0).Text + "\\" + ((TextBox)text_a0).Text + ".docx");

            }

            if (Directory.Exists(@".\\" + main.companyName + "\\wjgl\\102\\" + ((TextBox)text_a0).Text + ""))
            {
                // MessageBox.Show("存在文件夹");
                Directory.Delete(@".\\" + main.companyName + "\\wjgl\\102\\" + ((TextBox)text_a0).Text + "");
            }
      ...
      unsafe private void button1_Click(object sender, EventArgs e)
      {
        ...
        private void Record_show()
        {
            ...
            if (MyData.Tables[0].Rows[i][10].ToString()[0] == '1')
                a10_1.CheckState = CheckState.Checked;
            else
                a10_1.CheckState = CheckState.Unchecked;
            if (MyData.Tables[0].Rows[i][10].ToString()[1] == '1')
                a10_2.CheckState = CheckState.Checked;
            else
                a10_2.CheckState = CheckState.Unchecked;
            if (MyData.Tables[0].Rows[i][10].ToString()[2] == '1')
                a10_3.CheckState = CheckState.Checked;
            else
                a10_3.CheckState = CheckState.Unchecked;
            if (MyData.Tables[0].Rows[i][10].ToString()[3] == '1')
                a10_4.CheckState = CheckState.Checked;
            else
                a10_4.CheckState = CheckState.Unchecked;
            if (MyData.Tables[0].Rows[i][10].ToString()[4] == '1')
                a10_5.CheckState = CheckState.Checked;
            else
                a10_5.CheckState = CheckState.Unchecked;
            if (MyData.Tables[0].Rows[i][10].ToString()[5] == '1')
                a10_6.CheckState = CheckState.Checked;
            else
                a10_6.CheckState = CheckState.Unchecked;
