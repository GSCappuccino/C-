...
namespace MyApp
{
    public partial class _552_f : Form,FormFather
    {
        /*
          * 查询数据块-
          */
         ...
         * -查询数据块
         */
        private string DB_table_name = "e52bgmc"; 
        public static object text_a0;//传A0的值
        private string FormId = "552";
        //数据库链接
        ...
        public _552_f()
        {
            ...
            _552_f.MyConn = new OleDbConnection(_552_f.ConnString);
            _552_f.MyConn.Open();
            _552_f.MyAd = new OleDbDataAdapter("select *  from e52bgmc ", _552_f.MyConn);
            _552_f.MyAd.Fill(MyData);
            objCommandBuilder = new OleDbCommandBuilder(_552_f.MyAd);
            Directory.CreateDirectory(".\\" + main.companyName + "\\wjgl\\552");
        ...
        private void _552_f_Load(object sender, EventArgs e)
        {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            if (MyData.Tables[0].Rows.Count == 0)
                a0.Text = (55200001).ToString();
            else
            {
                OleDbDataAdapter MyAd00 = new OleDbDataAdapter("select a0  from e52bgmc order by a0 desc ", MyConn);
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            for (int v = 0; v < MyData.Tables[0].Rows.Count; v++)
            {
                ...
                if (this.a0.Text == MyData.Tables[0].Rows[v][0].ToString())
                {
                    ...
                    string SQL = "delete from e52bgmc where a0= '" + this.a0.Text + "'";
            ...
            */
            ...
            OleDbDataAdapter MyAd0 = new OleDbDataAdapter("select count(a0)  from e52bgmc ", MyConn);
        ...
        {
            this.Enabled = true;
            Directory.CreateDirectory(".\\" + main.companyName + "\\wjgl\\552\\" + a0.Text + "");

            string temp = System.IO.Directory.GetCurrentDirectory();// d当前运行路径

            //    MessageBox.Show(temp);
            string OrignFile;//word模板路径
            OrignFile = "\\baseDB\\商标书式\\3 续展变更转让许可质押注销\\5许可\\2变更许可人被许可人名称备案表.dot";
            ...
            object aa = temp + "\\" + main.companyName + "\\wjgl\\552\\" + a0.Text + "\\" + a0.Text + ".docx";

            object[] MyBM = new object[26];//创建一个书签数组
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            if (MyData.Tables[0].Rows.Count >= 1)
            {
                ...
                OleDbDataAdapter MyAd0 = new OleDbDataAdapter("select top 1 * from e52bgmc order by a0 desc", MyConn);
                DataSet MyData0 = new DataSet();
                MyAd0.Fill(MyData0);
        ...
        {
            Process.Start(".\\" + main.companyName + "\\wjgl\\552");
        }
        ...
        {
            //内存数据删除
            ((DataSet)_552_f.MyData_delete).Tables[0].Rows.RemoveAt(_552_f.i);


            // int a =;// 数据库删除
            string SQL = "delete * from e52bgmc where a0='" + ((TextBox)_552_f.text_a0).Text + "'";
            OleDbCommand NewCom = new OleDbCommand(SQL, _552_f.MyConn);
            ...
            if (File.Exists(@".\\" + main.companyName + "\\wjgl\\552\\" + ((TextBox)_552_f.text_a0).Text + "\\" + ((TextBox)_552_f.text_a0).Text + ".docx"))
            {
                // MessageBox.Show("存在文件");
                File.Delete(@".\\" + main.companyName + "\\wjgl\\552\\" + ((TextBox)_552_f.text_a0).Text + "\\" + ((TextBox)_552_f.text_a0).Text + ".docx");

            }

            if (Directory.Exists(@".\\" + main.companyName + "\\wjgl\\552\\" + ((TextBox)_552_f.text_a0).Text + ""))
            {
                // MessageBox.Show("存在文件夹");
                Directory.Delete(@".\\" + main.companyName + "\\wjgl\\552\\" + ((TextBox)_552_f.text_a0).Text + "");
            }
