...
namespace MyApp
{
    public partial class _551_f : Form,FormFather
    {
        /*
         * 查询数据块-
         */
         ...
         * -查询数据块
         */
        private string DB_table_name = "e51xkba"; 
        public static object text_a0;//传A0的值
        private string FormId="551";
        //数据库链接
        ...
        public _551_f()
        {
            ...
            _551_f.MyConn = new OleDbConnection(_551_f.ConnString);
            _551_f.MyConn.Open();
            _551_f.MyAd = new OleDbDataAdapter("select *  from e51xkba ", _551_f.MyConn);
            _551_f.MyAd.Fill(MyData);
            objCommandBuilder = new OleDbCommandBuilder(_551_f.MyAd);
            Directory.CreateDirectory(".\\" + main.companyName + "\\wjgl\\551");
            ...
            if (MyData.Tables[0].Rows.Count >= 1)
            {
                ...
                if (MyData.Tables[0].Rows[i][15].ToString() == "1")
                    a15.CheckState = CheckState.Checked;
                else
                    a15.CheckState = CheckState.Unchecked;
        ...
        private void _551_f_Load(object sender, EventArgs e)
        {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            if (MyData.Tables[0].Rows.Count == 0)
                a0.Text = (55100001).ToString();
            else
            {
                OleDbDataAdapter MyAd00 = new OleDbDataAdapter("select a0  from e51xkba order by a0 desc ", MyConn);
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            for (int v = 0; v < MyData.Tables[0].Rows.Count; v++)
            {
                ...
                if (this.a0.Text == MyData.Tables[0].Rows[v][0].ToString())
                {
                    ...
                    string SQL = "delete from e51xkba where a0= '" + this.a0.Text + "'";
            ...
            */
            ...
            NewRow["a13"] = a13.Text;
            NewRow["a14"] = a14.Text;
            if (a15.CheckState == CheckState.Checked)
                NewRow["a15"] = "1";
            else
                NewRow["a15"] = "0";
            NewRow["a16"] = a16.Text;
            ...
            OleDbDataAdapter MyAd0 = new OleDbDataAdapter("select count(a0)  from e51xkba ", MyConn);
        ...
        private void save()
        {
            ...
            Directory.CreateDirectory(".\\" + main.companyName + "\\wjgl\\551\\" + a0.Text + "");

            string temp = System.IO.Directory.GetCurrentDirectory();// d当前运行路径

            //    MessageBox.Show(temp);
            string OrignFile;//word模板路径
            OrignFile = "\\baseDB\\商标书式\\3 续展变更转让许可质押注销\\5许可\\1商标使用许可备案表.dot";
            ...
            object aa = temp + "\\" + main.companyName + "\\wjgl\\551\\" + a0.Text + "\\" + a0.Text + ".docx";

            object[] MyBM = new object[28];//创建一个书签数组

            for (int i = 0; i < 13; i++)//给书签数组赋值
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            if (MyData.Tables[0].Rows.Count >= 1)
            {
                ...
                OleDbDataAdapter MyAd0 = new OleDbDataAdapter("select top 1 * from e51xkba order by a0 desc", MyConn);
                DataSet MyData0 = new DataSet();
                MyAd0.Fill(MyData0);
        ...
        {
            Process.Start(".\\" + main.companyName + "\\wjgl\\551");
        }
       ...
       public void CleanApp()
        {
            //内存数据删除
            ((DataSet)_551_f.MyData_delete).Tables[0].Rows.RemoveAt(_551_f.i);


            // int a =;// 数据库删除
            string SQL = "delete * from e51xkba where a0='" + ((TextBox)_551_f.text_a0).Text + "'";
            OleDbCommand NewCom = new OleDbCommand(SQL, _551_f.MyConn);
            ...
            if (File.Exists(@".\\" + main.companyName + "\\wjgl\\551\\" + ((TextBox)_551_f.text_a0).Text + "\\" + ((TextBox)_551_f.text_a0).Text + ".docx"))
            {
                // MessageBox.Show("存在文件");
                File.Delete(@".\\" + main.companyName + "\\wjgl\\551\\" + ((TextBox)_551_f.text_a0).Text + "\\" + ((TextBox)_551_f.text_a0).Text + ".docx");

            }

            if (Directory.Exists(@".\\" + main.companyName + "\\wjgl\\551\\" + ((TextBox)_551_f.text_a0).Text + ""))
            {
                // MessageBox.Show("存在文件夹");
                Directory.Delete(@".\\" + main.companyName + "\\wjgl\\551\\" + ((TextBox)_551_f.text_a0).Text + "");
            }
