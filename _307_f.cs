...
namespace MyApp
{
    public partial class _307_f : Form,FormFather
    {  
        /*
* 查询数据块-
*/
         ...
         * * -查询数据块
        */
        private string DB_table_name = "c7cxsp"; 

        public object text_a0;//传A0的值
        private string FormId="307";
        //数据库链接
        ...
        public _307_f()
        {
            ...
            MyConn.Open();
           MyAd = new OleDbDataAdapter("select *  from c7cxsp ",MyConn);
            MyAd.Fill(MyData);
            objCommandBuilder = new OleDbCommandBuilder(MyAd);
            Directory.CreateDirectory(".\\" + main.companyName + "\\wjgl\\307");
        ...
        private void _307_f_Load(object sender, EventArgs e)
        {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            if (MyData.Tables[0].Rows.Count == 0)
                a0.Text = (30700001).ToString();
            else
            {

                OleDbDataAdapter MyAd00 = new OleDbDataAdapter("select a0  from c7cxsp order by a0 desc ", MyConn);
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            string SQL = "delete from c7cxsp where a0= '" + this.a0.Text + "'";
            ...
            */
            ...
            OleDbDataAdapter MyAd0 = new OleDbDataAdapter("select count(a0)  from c7cxsp", MyConn);
        ...
        {
            OleDbDataAdapter MyAd0 = new OleDbDataAdapter("select *  from c7cxsp", MyConn);
            DataSet MyData0 = new DataSet();
        ...
        {
            Process.Start(".\\" + main.companyName + "\\wjgl\\307");
        }
       ...
       public void CleanApp()
        {
            ...
            // int a =;// 数据库删除
            string SQL = "delete * from c7cxsp where a0='" + ((TextBox)text_a0).Text + "'";
            ...
            if (File.Exists(@".\\" + main.companyName + "\\wjgl\\307\\" + ((TextBox)text_a0).Text + "\\" + ((TextBox)text_a0).Text + ".docx"))
            {
                // MessageBox.Show("存在文件");
                File.Delete(@".\\" + main.companyName + "\\wjgl\\307\\" + ((TextBox)text_a0).Text + "\\" + ((TextBox)text_a0).Text + ".docx");
            }

            if (Directory.Exists(@".\\" + main.companyName + "\\wjgl\\307\\" + ((TextBox)text_a0).Text + ""))
            {
                // MessageBox.Show("存在文件夹");
                Directory.Delete(@".\\" + main.companyName + "\\wjgl\\307\\" + ((TextBox)text_a0).Text + "");
            }
