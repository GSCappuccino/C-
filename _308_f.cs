...
namespace MyApp
{
    public partial class _308_f : Form,FormFather
    {
        /*
* 查询数据块-
*/
         ...
         * * -查询数据块
        */
        private string DB_table_name = "c8chcx"; 
        public object text_a0;//传A0的值
        private string FormId="308";
        //数据库链接
        ...
        public _308_f()
        {
          ...
          MyConn.Open();
           MyAd = new OleDbDataAdapter("select *  from c8chcx ",MyConn);
            MyAd.Fill(MyData);
            objCommandBuilder = new OleDbCommandBuilder(MyAd);
            Directory.CreateDirectory(".\\" + main.companyName + "\\wjgl\\308");
        ...
        private void _308_f_Load(object sender, EventArgs e)
        {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            if (MyData.Tables[0].Rows.Count == 0)
                a0.Text = (30800001).ToString();
            else
            {

                OleDbDataAdapter MyAd00 = new OleDbDataAdapter("select a0  from c8chcx order by a0 desc ", MyConn);
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            string SQL = "delete from c8chcx where a0= '" + this.a0.Text + "'";
            ...
            */
            ...
            OleDbDataAdapter MyAd0 = new OleDbDataAdapter("select count(a0)  from c8chcx", MyConn);
        ...
        private void save()
        {
            ...
            Directory.CreateDirectory(".\\" + main.companyName + "\\wjgl\\308\\" + a0.Text + "");

            string temp = System.IO.Directory.GetCurrentDirectory();// d当前运行路径

            //    MessageBox.Show(temp);
            string OrignFile;//word模板路径
            OrignFile = "\\baseDB\\商标书式\\5 补证撤三出具证明\\08 撤回撤销成为商品服务通用名称注册商标申请书.dot";
            ...
            object aa = temp + "\\" + main.companyName + "\\wjgl\\308\\" + a0.Text + "\\" + a0.Text + ".docx";
        ...
        {
            OleDbDataAdapter MyAd0 = new OleDbDataAdapter("select *  from c8chcx", MyConn);
            DataSet MyData0 = new DataSet();
        ...
        {
            Process.Start(".\\" + main.companyName + "\\wjgl\\308");
        }
       ...
       public void CleanApp()
        {
            ...
            // int a =;// 数据库删除
            string SQL = "delete * from c8chcx where a0='" + ((TextBox)text_a0).Text + "'";
            ...
            if (File.Exists(@".\\" + main.companyName + "\\wjgl\\308\\" + ((TextBox)text_a0).Text + "\\" + ((TextBox)text_a0).Text + ".docx"))
            {
                // MessageBox.Show("存在文件");
                File.Delete(@".\\" + main.companyName + "\\wjgl\\308\\" + ((TextBox)text_a0).Text + "\\" + ((TextBox)text_a0).Text + ".docx");
            }

            if (Directory.Exists(@".\\" + main.companyName + "\\wjgl\\308\\" + ((TextBox)text_a0).Text + ""))
            {
                // MessageBox.Show("存在文件夹");
                Directory.Delete(@".\\" + main.companyName + "\\wjgl\\308\\" + ((TextBox)text_a0).Text + "");
            }
