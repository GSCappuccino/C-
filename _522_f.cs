...
namespace MyApp
{
    public partial class _522_f : Form,FormFather
    {  
        /*
         * 查询数据块-
         */
         ...
         * -查询数据块
         */
        private string DB_table_name = "e22chsb"; 
        public object text_a0;//传A0的值
        private string FormId="522";
        //数据库链接
        ...
        public _522_f()
        {
            ...
            MyConn.Open();
            MyAd = new OleDbDataAdapter("select *  from e22chsb ", MyConn);
            MyAd.Fill(MyData);
            objCommandBuilder = new OleDbCommandBuilder(MyAd);
            Directory.CreateDirectory(".\\" + main.companyName + "\\wjgl\\522");
        ...
        private void _522_f_Load(object sender, EventArgs e)
        {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            if (MyData.Tables[0].Rows.Count == 0)
                a0.Text = (52200001).ToString();
            else
            {
            
                OleDbDataAdapter MyAd00 = new OleDbDataAdapter("select a0  from e22chsb order by a0 desc ", MyConn);
            ...
            a13.Text = null;
            a14.Text = null;
            a12_1.CheckState = CheckState.Unchecked;
            a12_2.CheckState = CheckState.Unchecked;
            a16.Text = null;
            a17.Text = null;
            a18.Text = null;
            a19.Text = null;
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            for (int v = 0; v < MyData.Tables[0].Rows.Count; v++)
            {
                ...
                if (this.a0.Text == MyData.Tables[0].Rows[v][0].ToString())
                {
                    ...
                    string SQL = "delete from e22chsb where a0= '" + this.a0.Text + "'";
            ...
            */
            ...
            if (a12_2.CheckState == CheckState.Checked)
                NewRow["a12"] = NewRow["a12"].ToString() + '1';
            else
                NewRow["a12"] = NewRow["a12"].ToString() + '0';
            // NewRow["a15"] = a15.Text;
            NewRow["a16"] = a16.Text;
            NewRow["a17"] = a17.Text;
            NewRow["a18"] = a18.Text;
            ...
            OleDbDataAdapter MyAd0 = new OleDbDataAdapter("select count(a0)  from e22chsb ", MyConn);
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            ...
            {
                panel2.Enabled = false;
                OleDbDataAdapter MyAd0 = new OleDbDataAdapter("select top 1 * from e22chsb order by a0 desc", MyConn);
                DataSet MyData0 = new DataSet();
                MyAd0.Fill(MyData0);
        ...
        {
            OleDbDataAdapter MyAd0 = new OleDbDataAdapter("select *  from e22chsb ", MyConn);
            DataSet MyData0 = new DataSet();
        ...
        {
            Process.Start(".\\" + main.companyName + "\\wjgl\\522");
        }
       ...
       public void CleanApp()
        {
            ...
            // int a =;// 数据库删除
            string SQL = "delete * from e22chsb where a0='" + ((TextBox)text_a0).Text + "'";
            ...
            if (File.Exists(@".\\" + main.companyName + "\\wjgl\\522\\" + ((TextBox)text_a0).Text + "\\" + ((TextBox)text_a0).Text + ".docx"))
            {
                // MessageBox.Show("存在文件");
                File.Delete(@".\\" + main.companyName + "\\wjgl\\522\\" + ((TextBox)text_a0).Text + "\\" + ((TextBox)text_a0).Text + ".docx");

            }

            if (Directory.Exists(@".\\" + main.companyName + "\\wjgl\\522\\" + ((TextBox)text_a0).Text + ""))
            {
                // MessageBox.Show("存在文件夹");
                Directory.Delete(@".\\" + main.companyName + "\\wjgl\\522\\" + ((TextBox)text_a0).Text + "");
            }
       ...
       private void Record_show()
       {
           ...
           if (MyData.Tables[0].Rows[i][12].ToString()[0] == '1')
               a12_1.CheckState = CheckState.Checked;
           if (MyData.Tables[0].Rows[i][12].ToString()[1] == '1')
               a12_2.CheckState = CheckState.Checked;
           // a15.Text = MyData.Tables[0].Rows[i][15].ToString();
