...
namespace MyApp
{
    public partial class _104_f : Form,FormFather
    {
        /*
    * 查询数据块-
    */
        ...
        */
        ...
        private string DB_table_name = "ayxzm4";
        private string FormId="104";
        ...
        public _104_f()
        {
            ...
            MyConn.Open();
            MyAd = new OleDbDataAdapter("select *  from ayxzm4 ",MyConn);
            MyAd.Fill(MyData);
            objCommandBuilder = new OleDbCommandBuilder(MyAd);
            Directory.CreateDirectory(".\\" + main.companyName + "\\wjgl\\104");
        ...
        private void _104_f_Load(object sender, EventArgs e)
        {
        ...
        {
            Process.Start(".\\" + main.companyName + "\\wjgl\\104");
        }
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            if (MyData.Tables[0].Rows.Count == 0)
                a0.Text = (10400001).ToString();
            else
            {
            
                OleDbDataAdapter MyAd00 = new OleDbDataAdapter("select a0  from ayxzm4 order by a0 desc ", MyConn);
        ...
        { 
            string SQL = "delete from ayxzm4 where a0= '" + this.a0.Text + "'";
            ...
            */
            ...
            OleDbDataAdapter MyAd0 = new OleDbDataAdapter("select count(a0)  from ayxzm4 ", MyConn);
        ...
        private void save()
        {
          ...
          //  throw new NotImplementedException();
            Directory.CreateDirectory(".\\" + main.companyName + "\\wjgl\\104\\" + a0.Text + "");

            string temp = System.IO.Directory.GetCurrentDirectory();// d当前运行路径

            //    MessageBox.Show(temp);
            string OrignFile;//word模板路径
            OrignFile = "\\baseDB\\商标书式\\1 注册申请\\04 出具优先权证明文件申请书.dot";
            ...
            object aa = temp + "\\" + main.companyName + "\\wjgl\\104\\" + a0.Text + "\\" + a0.Text + ".docx";
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            if (MyData.Tables[0].Rows.Count >= 1)
            {
                ...
                OleDbDataAdapter MyAd0 = new OleDbDataAdapter("select top 1 * from ayxzm4 order by a0 desc", MyConn);
                DataSet MyData0 = new DataSet();
                MyAd0.Fill(MyData0);
        ...
        {
            OleDbDataAdapter MyAd0 = new OleDbDataAdapter("select *  from ayxzm4 ", MyConn);
            DataSet MyData0 = new DataSet();
       ...
       public void CleanApp()
        {
            ...
            // int a =;// 数据库删除
            string SQL = "delete * from ayxzm4 where a0='" + ((TextBox)text_a0).Text + "'";
            ...
            if (File.Exists(@".\\" + main.companyName + "\\wjgl\\104\\" + ((TextBox)text_a0).Text + "\\" + ((TextBox)text_a0).Text + ".docx"))
            {
                // MessageBox.Show("存在文件");
                File.Delete(@".\\" + main.companyName + "\\wjgl\\104\\" + ((TextBox)text_a0).Text + "\\" + ((TextBox)text_a0).Text + ".docx");

            }

            if (Directory.Exists(@".\\" + main.companyName + "\\wjgl\\104\\" + ((TextBox)text_a0).Text + ""))
            {
                // MessageBox.Show("存在文件夹");
                Directory.Delete(@".\\" + main.companyName + "\\wjgl\\104\\" + ((TextBox)text_a0).Text + "");
            }
