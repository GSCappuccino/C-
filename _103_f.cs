...
namespace MyApp
{
    public partial class _103_f : Form,FormFather
    {
        /*
     * 查询数据块-
     */
         ...
         * * -查询数据块
        */
        string DB_table_name = "achsq3";
        public  object text_a0;//传A0的值
        private string FormId="103";
        //数据库链接
        ...
        public _103_f()
        {
            ...
            Directory.CreateDirectory(".\\" + main.companyName + "\\wjgl\\103");
        ...
        private void _103_f_Load(object sender, EventArgs e)
        {
        ...
        {
            Process.Start(".\\" + main.companyName + "\\wjgl\\103");
        }
        ...
        {
            this.Enabled = false;
           Directory.CreateDirectory(".\\" + main.companyName + "\\wjgl\\103\\" + a0.Text + "");

            string temp = System.IO.Directory.GetCurrentDirectory();// d当前运行路径

            //    MessageBox.Show(temp);
            string OrignFile;//word模板路径
            OrignFile = "\\baseDB\\商标书式\\1 注册申请\\03 撤回商标注册申请申请书.dot";
            ...
            object aa = temp + "\\" + main.companyName + "\\wjgl\\103\\" + a0.Text + "\\" + a0.Text + ".docx";
        ...
        public void CleanApp()
        {
            ...
            if (File.Exists(@".\\" + main.companyName + "\\wjgl\\103\\" + ((TextBox)text_a0).Text + "\\" + ((TextBox)text_a0).Text + ".docx"))
            {
                // MessageBox.Show("存在文件");
                File.Delete(@".\\" + main.companyName + "\\wjgl\\103\\" + ((TextBox)text_a0).Text + "\\" + ((TextBox)text_a0).Text + ".docx");

            }

            if (Directory.Exists(@".\\" + main.companyName + "\\wjgl\\103\\" + ((TextBox)text_a0).Text + ""))
            {
                // MessageBox.Show("存在文件夹");
                Directory.Delete(@".\\" + main.companyName + "\\wjgl\\103\\" + ((TextBox)text_a0).Text + "");
            }
