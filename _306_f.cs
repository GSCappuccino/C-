...
namespace MyApp
{
    public partial class _306_f : Form,FormFather
    {
        /*
* 查询数据块-
*/
         ...
         * * -查询数据块
        */
        private string DB_table_name = "c6cxsn"; 
        public object text_a0;//传A0的值
        private string FormId="306";
        //数据库链接
        ...
        public _306_f()
        {
            ...
            MyConn.Open();
            MyAd = new OleDbDataAdapter("select *  from c6cxsn ", MyConn);
            MyAd.Fill(MyData);
            objCommandBuilder = new OleDbCommandBuilder(MyAd);
            Directory.CreateDirectory(".\\" + main.companyName + "\\wjgl\\306");
        ...
        private void _306_f_Load(object sender, EventArgs e)
        {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            if (MyData.Tables[0].Rows.Count == 0)
                a0.Text = (30600001).ToString();
            else
            {
     
                OleDbDataAdapter MyAd00 = new OleDbDataAdapter("select a0  from c6cxsn order by a0 desc ", MyConn);
        ...
        {
            string SQL = "delete from c6cxsn where a0= '" + this.a0.Text + "'";
            ...
            */
            ...
            OleDbDataAdapter MyAd0 = new OleDbDataAdapter("select count(a0)  from c6cxsn", MyConn);
        ...
        private void save()
        {
            ...
            Directory.CreateDirectory(".\\" + main.companyName + "\\wjgl\\306\\" + a0.Text + "");

            string temp = System.IO.Directory.GetCurrentDirectory();// d当前运行路径

            //    MessageBox.Show(temp);
            string OrignFile;//word模板路径
            OrignFile = "\\baseDB\\商标书式\\5 补证撤三出具证明\\06 撤回撤销连续三年不使用注册商标申请书.dot";
            ...
            object aa = temp + "\\" + main.companyName + "\\wjgl\\306\\" + a0.Text + "\\" + a0.Text + ".docx";
        ...
        {
            OleDbDataAdapter MyAd0 = new OleDbDataAdapter("select *  from c6cxsn", MyConn);
            DataSet MyData0 = new DataSet();
        ...
        {
            Process.Start(".\\" + main.companyName + "\\wjgl\\306");
        }
       ...
       public void CleanApp()
        {
            ...
            // int a =;// 数据库删除
            string SQL = "delete * from c6cxsn where a0='" + ((TextBox)text_a0).Text + "'";
            ...
            if (File.Exists(@".\\" + main.companyName + "\\wjgl\\306\\" + ((TextBox)text_a0).Text + "\\" + ((TextBox)text_a0).Text + ".docx"))
            {
                // MessageBox.Show("存在文件");
                File.Delete(@".\\" + main.companyName + "\\wjgl\\306\\" + ((TextBox)text_a0).Text + "\\" + ((TextBox)text_a0).Text + ".docx");
            }

            if (Directory.Exists(@".\\" + main.companyName + "\\wjgl\\306\\" + ((TextBox)text_a0).Text + ""))
            {
                // MessageBox.Show("存在文件夹");
                Directory.Delete(@".\\" + main.companyName + "\\wjgl\\306\\" + ((TextBox)text_a0).Text + "");
            }
