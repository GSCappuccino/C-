...
namespace MyApp
{
    public partial class _553_f : Form,FormFather
    {
        /*
          * 查询数据块-
          */
         ...
         * -查询数据块
         */
        private string DB_table_name = "e53tjzz"; 
        public static object text_a0;//传A0的值
        private string FormId="553";
        //数据库链接
        ...
        public _553_f()
        {
            ...
            _553_f.MyConn = new OleDbConnection(_553_f.ConnString);
            _553_f.MyConn.Open();
            _553_f.MyAd = new OleDbDataAdapter("select *  from e53tjzz ", _553_f.MyConn);
            _553_f.MyAd.Fill(MyData);
            objCommandBuilder = new OleDbCommandBuilder(_553_f.MyAd);
            Directory.CreateDirectory(".\\" + main.companyName + "\\wjgl\\553");
        ...
        private void _553_f_Load(object sender, EventArgs e)
        {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            if (MyData.Tables[0].Rows.Count == 0)
                a0.Text = (55300001).ToString();
            else
            {
                OleDbDataAdapter MyAd00 = new OleDbDataAdapter("select a0  from e53tjzz order by a0 desc ", MyConn);
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            for (int v = 0; v < MyData.Tables[0].Rows.Count; v++)
            {
                ...
                if (this.a0.Text == MyData.Tables[0].Rows[v][0].ToString())
                {
                    ...
                    string SQL = "delete from e53tjzz where a0= '" + this.a0.Text + "'";
            ...
            */
            ...
            OleDbDataAdapter MyAd0 = new OleDbDataAdapter("select count(a0)  from e53tjzz ", MyConn);
        ...
        {
            this.Enabled = true;
            Directory.CreateDirectory(".\\" + main.companyName + "\\wjgl\\553\\" + a0.Text + "");

            string temp = System.IO.Directory.GetCurrentDirectory();// d当前运行路径

            //    MessageBox.Show(temp);
            string OrignFile;//word模板路径
            OrignFile = "\\baseDB\\商标书式\\3 续展变更转让许可质押注销\\5许可\\3商标使用许可提前终止备案表.dot";
            ...
            object aa = temp + "\\" + main.companyName + "\\wjgl\\553\\" + a0.Text + "\\" + a0.Text + ".docx";
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            if (MyData.Tables[0].Rows.Count >= 1)
            {
                ...
                OleDbDataAdapter MyAd0 = new OleDbDataAdapter("select top 1 * from e53tjzz order by a0 desc", MyConn);
                DataSet MyData0 = new DataSet();
                MyAd0.Fill(MyData0);
        ...
        {
            Process.Start(".\\" + main.companyName + "\\wjgl\\553");
        }
       ...
       public void CleanApp()
        {
            //内存数据删除
            ((DataSet)_553_f.MyData_delete).Tables[0].Rows.RemoveAt(_553_f.i);


            // int a =;// 数据库删除
            string SQL = "delete * from e53tjzz where a0='" + ((TextBox)_553_f.text_a0).Text + "'";
            OleDbCommand NewCom = new OleDbCommand(SQL, _553_f.MyConn);
            ...
            if (File.Exists(@".\\" + main.companyName + "\\wjgl\\553\\" + ((TextBox)_553_f.text_a0).Text + "\\" + ((TextBox)_553_f.text_a0).Text + ".docx"))
            {
                // MessageBox.Show("存在文件");
                File.Delete(@".\\" + main.companyName + "\\wjgl\\553\\" + ((TextBox)_553_f.text_a0).Text + "\\" + ((TextBox)_553_f.text_a0).Text + ".docx");

            }

            if (Directory.Exists(@".\\" + main.companyName + "\\wjgl\\553\\" + ((TextBox)_553_f.text_a0).Text + ""))
            {
                // MessageBox.Show("存在文件夹");
                Directory.Delete(@".\\" + main.companyName + "\\wjgl\\553\\" + ((TextBox)_553_f.text_a0).Text + "");
            }
