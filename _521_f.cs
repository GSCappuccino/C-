...
namespace MyApp
{
    public partial class _521_f : Form,FormFather
    {
        /*
* 查询数据块-
*/
         ...
         * * -查询数据块
        */
        private string DB_table_name = "e21bgsb"; 
        ...
        public _521_f()
        {
            ...
            MyConn.Open();
            MyAd = new OleDbDataAdapter("select *  from e21bgsb ",MyConn);
            MyAd.Fill(MyData);
            objCommandBuilder = new OleDbCommandBuilder(MyAd);
            Directory.CreateDirectory(".\\" + main.companyName + "\\wjgl\\521");
        ...
        private void _521_f_Load(object sender, EventArgs e)
        {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            if (MyData.Tables[0].Rows.Count == 0)
                a0.Text = (52100001).ToString();
            else
            {

                OleDbDataAdapter MyAd00 = new OleDbDataAdapter("select a0  from e21bgsb order by a0 desc ", MyConn);
            ...
            a13.Text = null;
            a14.Text = null;
            a15_1.CheckState = CheckState.Unchecked;
            a15_2.CheckState = CheckState.Unchecked;
            a16.Text = null;
            a17.Text = null;
            a18.Text = null;
            a19.Text = null;
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            for (int v = 0; v < MyData.Tables[0].Rows.Count; v++)
            {
                ...
                if (this.a0.Text == MyData.Tables[0].Rows[v][0].ToString())
                {
                    ...
                    string SQL = "delete from e21bgsb where a0= '" + this.a0.Text + "'";
            ...
            */
            ...
            NewRow["a13"] = a13.Text;
            NewRow["a14"] = a14.Text;
            if (a15_1.CheckState==CheckState.Checked)
                NewRow["a15"]='1';
            else
                NewRow["a15"] = '0';
            if (a15_2.CheckState == CheckState.Checked)
                NewRow["a15"] = NewRow["a15"].ToString()+'1';
            else
                NewRow["a15"] = NewRow["a15"].ToString() + '0';
           // NewRow["a15"] = a15.Text;
            NewRow["a16"] = a16.Text;
            NewRow["a17"] = a17.Text;
            NewRow["a18"] = a18.Text;
            ...
            OleDbDataAdapter MyAd0 = new OleDbDataAdapter("select count(a0)  from e21bgsb ", MyConn);
        ...
        private void save()
        {
            ...
            Directory.CreateDirectory(".\\" + main.companyName + "\\wjgl\\521\\" + a0.Text + "");

            string temp = System.IO.Directory.GetCurrentDirectory();// d当前运行路径

            //    MessageBox.Show(temp);
            string OrignFile;//word模板路径
            OrignFile = "\\baseDB\\商标书式\\3 续展变更转让许可质押注销\\2变更\\1变更商标申请人注册人名义地址变更集体商标证明商标管理规则集体成员名单申请书.dot";
            ...
            object aa = temp + "\\" + main.companyName + "\\wjgl\\521\\" + a0.Text + "\\" + a0.Text + ".docx";
            ...
            for (int i = 11; i < 15; i++)//给书签数组赋值
                MyBM[i] = "a" + (i).ToString();
            MyBM[15] = "a15_1";
            MyBM[16] = "a15_2";
            for (int i = 17; i < 34; i++)//给书签数组赋值
                MyBM[i] = "a" + (i-1).ToString();
            ...
            doc.Bookmarks.get_Item(ref MyBM[12]).Range.Text = a12.Text;
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            if (MyData.Tables[0].Rows.Count >= 1)
            {
                ...
                OleDbDataAdapter MyAd0 = new OleDbDataAdapter("select top 1 * from e21bgsb order by a0 desc", MyConn);
                DataSet MyData0 = new DataSet();
                MyAd0.Fill(MyData0);
        ...
        {
            OleDbDataAdapter MyAd0 = new OleDbDataAdapter("select *  from e21bgsb ", MyConn);
            DataSet MyData0 = new DataSet();
        ...
        {
            Process.Start(".\\" + main.companyName + "\\wjgl\\521");
        }
      ...
      public  void CleanApp()
        {
            ...
            // int a =;// 数据库删除
            string SQL = "delete * from e21bgsb where a0='" + ((TextBox)text_a0).Text + "'";
            ...
            if (File.Exists(@".\\" + main.companyName + "\\wjgl\\521\\" + ((TextBox)text_a0).Text + "\\" + ((TextBox)text_a0).Text + ".docx"))
            {
                // MessageBox.Show("存在文件");
                File.Delete(@".\\" + main.companyName + "\\wjgl\\521\\" + ((TextBox)text_a0).Text + "\\" + ((TextBox)text_a0).Text + ".docx");

            }

            if (Directory.Exists(@".\\" + main.companyName + "\\wjgl\\521\\" + ((TextBox)text_a0).Text + ""))
            {
                // MessageBox.Show("存在文件夹");
                Directory.Delete(@".\\" + main.companyName + "\\wjgl\\521\\" + ((TextBox)text_a0).Text + "");
            }
      ...
      private void Record_show()
      {
          ...
          if (MyData.Tables[0].Rows[i][15].ToString()[0] == '1')
              a15_1.CheckState = CheckState.Checked;
          if (MyData.Tables[0].Rows[i][15].ToString()[1] == '1')
              a15_2.CheckState = CheckState.Checked;
