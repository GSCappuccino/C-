...
namespace MyApp
{
    public partial class _304_f : Form,FormFather
    {
        /*
* 查询数据块-
*/
         ...
         * * -查询数据块
        */
        private string DB_table_name = "c4gzzc"; 
        public  object text_a0;//传A0的值
        private string FormId="304";
        //数据库链接
        ...
        public _304_f()
        {
            ...
            MyConn.Open();
            MyAd = new OleDbDataAdapter("select *  from c4gzzc ", MyConn);
            MyAd.Fill(MyData);
            objCommandBuilder = new OleDbCommandBuilder(MyAd);
            Directory.CreateDirectory(".\\" + main.companyName + "\\wjgl\\304");
        ...
        private void _304_f_Load(object sender, EventArgs e)
        {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            if (MyData.Tables[0].Rows.Count == 0)
                a0.Text = (30400001).ToString();
            else
            {
              
                OleDbDataAdapter MyAd00 = new OleDbDataAdapter("select a0  from c4gzzc order by a0 desc ", MyConn);
        ...
        {
            string SQL = "delete from c4gzzc where a0= '" + this.a0.Text + "'";
            ...
            */
            ...
            OleDbDataAdapter MyAd0 = new OleDbDataAdapter("select count(a0)  from c4gzzc ", MyConn);
        ...
        private void save()
        {
            ...
            Directory.CreateDirectory(".\\" + main.companyName + "\\wjgl\\304\\" + a0.Text + "");

            string temp = System.IO.Directory.GetCurrentDirectory();// d当前运行路径

            //    MessageBox.Show(temp);
            string OrignFile;//word模板路径
            OrignFile = "\\baseDB\\商标书式\\5 补证撤三出具证明\\04 更正商标申请注册事项申请书.dot";
            ...
            object aa = temp + "\\" + main.companyName + "\\wjgl\\304\\" + a0.Text + "\\" + a0.Text + ".docx";

            object[] MyBM = new object[11];//创建一个书签数组
            ...
            doc.Bookmarks.get_Item(ref MyBM[10]).Range.Text = a10.Text;
            doc.SaveAs(ref aa);
            doc.Close();  
            this.Enabled = true;
        }
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            if (MyData.Tables[0].Rows.Count >= 1)
            {
                ...
                OleDbDataAdapter MyAd0 = new OleDbDataAdapter("select top 1 * from c4gzzc order by a0 desc", MyConn);
                DataSet MyData0 = new DataSet();
                MyAd0.Fill(MyData0);
        ...
        {
            OleDbDataAdapter MyAd0 = new OleDbDataAdapter("select *  from c4gzzc ", MyConn);
            DataSet MyData0 = new DataSet();
        ...
        {
            Process.Start(".\\" + main.companyName + "\\wjgl\\304");
        }
       ...
       public void CleanApp()
        {
            ...
            // int a =;// 数据库删除
            string SQL = "delete * from c4gzzc where a0='" + ((TextBox)text_a0).Text + "'";
            ...
            if (File.Exists(@".\\" + main.companyName + "\\wjgl\\304\\" + ((TextBox)text_a0).Text + "\\" + ((TextBox)text_a0).Text + ".docx"))
            {
                // MessageBox.Show("存在文件");
                File.Delete(@".\\" + main.companyName + "\\wjgl\\304\\" + ((TextBox)text_a0).Text + "\\" + ((TextBox)text_a0).Text + ".docx");

            }

            if (Directory.Exists(@".\\" + main.companyName + "\\wjgl\\304\\" + ((TextBox)text_a0).Text + ""))
            {
                // MessageBox.Show("存在文件夹");
                Directory.Delete(@".\\" + main.companyName + "\\wjgl\\304\\" + ((TextBox)text_a0).Text + "");
            }
