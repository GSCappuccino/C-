...
namespace MyApp
{
    public partial class _541_f : Form,FormFather
    {
         ...
         * -查询数据块
         */
        private string DB_table_name = "e41zryz"; 
        public static object text_a0;//传A0的值
        private string FormId="541";
        //数据库链接
        ...
        public _541_f()
        {
            ...
            _541_f.MyConn = new OleDbConnection(_541_f.ConnString);
            _541_f.MyConn.Open();
            _541_f.MyAd = new OleDbDataAdapter("select *  from e41zryz ", _541_f.MyConn);
            _541_f.MyAd.Fill(MyData);
            objCommandBuilder = new OleDbCommandBuilder(_541_f.MyAd);
            Directory.CreateDirectory(".\\" + main.companyName + "\\wjgl\\541");
        ...
        {
            Process.Start(".\\" + main.companyName + "\\wjgl\\541");
        }

        private void _541_f_Load(object sender, EventArgs e)
        {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            if (MyData.Tables[0].Rows.Count == 0)
                a0.Text = (54100001).ToString();
            else
            {
                OleDbDataAdapter MyAd00 = new OleDbDataAdapter("select a0  from e41zryz order by a0 desc ", MyConn);
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            for (int v = 0; v < MyData.Tables[0].Rows.Count; v++)
            {
                ...
                if (this.a0.Text == MyData.Tables[0].Rows[v][0].ToString())
                {
                    ...
                    string SQL = "delete from e41zryz where a0= '" + this.a0.Text + "'";
            ...
            */
            ...
            OleDbDataAdapter MyAd0 = new OleDbDataAdapter("select count(a0)  from e41zryz ", MyConn);
        ...
        private void save()
        {
            ...
            Directory.CreateDirectory(".\\" + main.companyName + "\\wjgl\\541\\" + a0.Text + "");

            string temp = System.IO.Directory.GetCurrentDirectory();// d当前运行路径

            //    MessageBox.Show(temp);
            string OrignFile;//word模板路径
            OrignFile = "\\baseDB\\商标书式\\3 续展变更转让许可质押注销\\4转让\\1转让移转申请注册商标申请书.dot";
            ...
            object aa = temp + "\\" + main.companyName + "\\wjgl\\541\\" + a0.Text + "\\" + a0.Text + ".docx";
            ...
            doc.Bookmarks.get_Item(ref MyBM[33]).Range.Text = a33.Text;
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            if (MyData.Tables[0].Rows.Count >= 1)
            {
                ...
                OleDbDataAdapter MyAd0 = new OleDbDataAdapter("select top 1 * from e41zryz order by a0 desc", MyConn);
                DataSet MyData0 = new DataSet();
                MyAd0.Fill(MyData0);
        ...
        {
            OleDbDataAdapter MyAd0 = new OleDbDataAdapter("select *  from e41zryz ", MyConn);
            DataSet MyData0 = new DataSet();
        ...
        {
            //内存数据删除
            ((DataSet)_541_f.MyData_delete).Tables[0].Rows.RemoveAt(_541_f.i);


            // int a =;// 数据库删除
            string SQL = "delete * from e41zryz where a0='" + ((TextBox)_541_f.text_a0).Text + "'";
            OleDbCommand NewCom = new OleDbCommand(SQL, _541_f.MyConn);
            ...
            if (File.Exists(@".\\" + main.companyName + "\\wjgl\\541\\" + ((TextBox)_541_f.text_a0).Text + "\\" + ((TextBox)_541_f.text_a0).Text + ".docx"))
            {
                // MessageBox.Show("存在文件");
                File.Delete(@".\\" + main.companyName + "\\wjgl\\541\\" + ((TextBox)_541_f.text_a0).Text + "\\" + ((TextBox)_541_f.text_a0).Text + ".docx");

            }

            if (Directory.Exists(@".\\" + main.companyName + "\\wjgl\\541\\" + ((TextBox)_541_f.text_a0).Text + ""))
            {
                // MessageBox.Show("存在文件夹");
                Directory.Delete(@".\\" + main.companyName + "\\wjgl\\541\\" + ((TextBox)_541_f.text_a0).Text + "");
            }
