...
namespace MyApp
{
    public partial class _563_f : Form,FormFather
    {
        /*
                    * 查询数据块-
                    */
         ...
         * -查询数据块
         */
        private string DB_table_name = "e63djyq"; 
        public static object text_a0;//传A0的值
        private string FormId = "563";
        //数据库链接
        ...
        public _563_f()
        {
            ...
            _563_f.MyConn = new OleDbConnection(_563_f.ConnString);
            _563_f.MyConn.Open();
            _563_f.MyAd = new OleDbDataAdapter("select *  from e63djyq ", _563_f.MyConn);
            _563_f.MyAd.Fill(MyData);
            objCommandBuilder = new OleDbCommandBuilder(_563_f.MyAd);
            Directory.CreateDirectory(".\\" + main.companyName + "\\wjgl\\563");
        ...
        private void _563_f_Load(object sender, EventArgs e)
        {
        ...
        {
            Process.Start(".\\" + main.companyName + "\\wjgl\\563");
        }
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            if (MyData.Tables[0].Rows.Count == 0)
                a0.Text = (56300001).ToString();
            else
            {
                OleDbDataAdapter MyAd00 = new OleDbDataAdapter("select a0  from e63djyq order by a0 desc ", MyConn);
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            for (int v = 0; v < MyData.Tables[0].Rows.Count; v++)
            {
                ...
                if (this.a0.Text == MyData.Tables[0].Rows[v][0].ToString())
                {
                    ...
                    string SQL = "delete from e63djyq where a0= '" + this.a0.Text + "'";
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            if (MyData.Tables[0].Rows.Count >= 1)
            {
                ...
                OleDbDataAdapter MyAd0 = new OleDbDataAdapter("select top 1 * from e63djyq order by a0 desc", MyConn);
       ...
       public void CleanApp()
        {
            //内存数据删除
            ((DataSet)_563_f.MyData_delete).Tables[0].Rows.RemoveAt(_563_f.i);


            // int a =;// 数据库删除
            string SQL = "delete * from e63djyq where a0='" + ((TextBox)_563_f.text_a0).Text + "'";
            OleDbCommand NewCom = new OleDbCommand(SQL, _563_f.MyConn);
            ...
            if (File.Exists(@".\\" + main.companyName + "\\wjgl\\563\\" + ((TextBox)_563_f.text_a0).Text + "\\" + ((TextBox)_563_f.text_a0).Text + ".docx"))
            {
                // MessageBox.Show("存在文件");
                File.Delete(@".\\" + main.companyName + "\\wjgl\\563\\" + ((TextBox)_563_f.text_a0).Text + "\\" + ((TextBox)_563_f.text_a0).Text + ".docx");

            }

            if (Directory.Exists(@".\\" + main.companyName + "\\wjgl\\563\\" + ((TextBox)_563_f.text_a0).Text + ""))
            {
                // MessageBox.Show("存在文件夹");
                Directory.Delete(@".\\" + main.companyName + "\\wjgl\\563\\" + ((TextBox)_563_f.text_a0).Text + "");
            }
