...
namespace MyApp
{
    public partial class _562_f : Form,FormFather
    {
        /*
                * 查询数据块-
                */
         ...
         * -查询数据块
         */
        private string DB_table_name = "e62zqbg"; 
        public static object text_a0;//传A0的值
        private string FormId = "562";
        //数据库链接
        ...
        public _562_f()
        {
            ...
            _562_f.MyConn = new OleDbConnection(_562_f.ConnString);
            _562_f.MyConn.Open();
            _562_f.MyAd = new OleDbDataAdapter("select *  from e62zqbg ", _562_f.MyConn);
            _562_f.MyAd.Fill(MyData);
            objCommandBuilder = new OleDbCommandBuilder(_562_f.MyAd);
            Directory.CreateDirectory(".\\" + main.companyName + "\\wjgl\\562");
            ...
            if (MyData.Tables[0].Rows.Count >= 1)
            {
                ...
                if (MyData.Tables[0].Rows[i][16].ToString()[0] == '1')
                    a16_1.CheckState = CheckState.Checked;
                if (MyData.Tables[0].Rows[i][16].ToString()[1] == '1')
                    a16_2.CheckState = CheckState.Checked;
                if (MyData.Tables[0].Rows[i][16].ToString()[2] == '1')
                    a16_3.CheckState = CheckState.Checked;
                ...
                a33.Text = MyData.Tables[0].Rows[i][33].ToString();
                a34.Text = MyData.Tables[0].Rows[i][34].ToString();
                a35.Text = MyData.Tables[0].Rows[i][35].ToString();
                a36.Text = MyData.Tables[0].Rows[i][36].ToString();
                a37.Text = MyData.Tables[0].Rows[i][37].ToString();
                a38.Text = MyData.Tables[0].Rows[i][38].ToString();
                a39.Text = MyData.Tables[0].Rows[i][39].ToString();


                a40.Text = MyData.Tables[0].Rows[i][40].ToString();
                a41.Text = MyData.Tables[0].Rows[i][41].ToString();
                a42.Text = MyData.Tables[0].Rows[i][42].ToString();
                a43.Text = MyData.Tables[0].Rows[i][43].ToString();
                a44.Text = MyData.Tables[0].Rows[i][44].ToString();
                a45.Text = MyData.Tables[0].Rows[i][45].ToString();
                a46.Text = MyData.Tables[0].Rows[i][46].ToString();
                a47.Text = MyData.Tables[0].Rows[i][47].ToString();
                a48.Text = MyData.Tables[0].Rows[i][48].ToString();
                a49.Text = MyData.Tables[0].Rows[i][49].ToString();


                a50.Text = MyData.Tables[0].Rows[i][50].ToString();
        ...
        private void _562_f_Load(object sender, EventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                a14.Text = null;
                a15.Text = null;
                a16_1.CheckState=CheckState.Unchecked;
                a16_2.CheckState = CheckState.Unchecked;
                a16_3.CheckState = CheckState.Unchecked;
                a17.Text = null;
                a18.Text = null;
                a19.Text = null;
                a20.Text = null;
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            if (MyData.Tables[0].Rows.Count == 0)
                a0.Text = (56200001).ToString();
            else
            {
                OleDbDataAdapter MyAd00 = new OleDbDataAdapter("select a0  from e62zqbg order by a0 desc ", MyConn);
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            for (int v = 0; v < MyData.Tables[0].Rows.Count; v++)
            {
                ...
                if (this.a0.Text == MyData.Tables[0].Rows[v][0].ToString())
                {
                    ...
                    string SQL = "delete from e62zqbg where a0= '" + this.a0.Text + "'";
            ...
            */
            ...
            NewRow["a14"] = a14.Text;
            NewRow["a15"] = a15.Text;
            if (a16_1.CheckState == CheckState.Checked)
                NewRow["a16"] += "1";
            else
                NewRow["a16"] += "0";
            if (a16_2.CheckState == CheckState.Checked)
                NewRow["a16"] += "1";
            else
                NewRow["a16"] += "0";
            if (a16_3.CheckState == CheckState.Checked)
                NewRow["a16"] += "1";
            else
                NewRow["a16"] += "0";
            NewRow["a17"] = a17.Text;
        ...
        {
            this.Enabled = true;
            Directory.CreateDirectory(".\\" + main.companyName + "\\wjgl\\562\\" + a0.Text + "");

            string temp = System.IO.Directory.GetCurrentDirectory();// d当前运行路径

            //    MessageBox.Show(temp);
            string OrignFile;//word模板路径
            OrignFile = "\\baseDB\\商标书式\\3 续展变更转让许可质押注销\\6质押\\2商标专用权质权登记事项变更申请书.dot";
            ...
            object aa = temp + "\\" + main.companyName + "\\wjgl\\562\\" + a0.Text + "\\" + a0.Text + ".docx";

            object[] MyBM = new object[52];//创建一个书签数组

            for (int i = 0; i < 15; i++)//给书签数组赋值
            ...
            doc.Bookmarks.get_Item(ref MyBM[23]).Range.Text = a22.Text;
            doc.Bookmarks.get_Item(ref MyBM[24]).Range.Text = a23.Text;
            doc.Bookmarks.get_Item(ref MyBM[25]).Range.Text = a24.Text;
            doc.Bookmarks.get_Item(ref MyBM[26]).Range.Text = a25.Text;
            doc.Bookmarks.get_Item(ref MyBM[27]).Range.Text = a26.Text;
            doc.Bookmarks.get_Item(ref MyBM[28]).Range.Text = a27.Text;
            doc.Bookmarks.get_Item(ref MyBM[29]).Range.Text = a28.Text;
            doc.Bookmarks.get_Item(ref MyBM[30]).Range.Text = a29.Text;
            doc.Bookmarks.get_Item(ref MyBM[31]).Range.Text = a30.Text;
            doc.Bookmarks.get_Item(ref MyBM[32]).Range.Text = a31.Text;
            doc.Bookmarks.get_Item(ref MyBM[33]).Range.Text = a32.Text;
            doc.Bookmarks.get_Item(ref MyBM[34]).Range.Text = a33.Text;
            doc.Bookmarks.get_Item(ref MyBM[35]).Range.Text = a34.Text;
            doc.Bookmarks.get_Item(ref MyBM[36]).Range.Text = a35.Text;
            doc.Bookmarks.get_Item(ref MyBM[37]).Range.Text = a36.Text;
            doc.Bookmarks.get_Item(ref MyBM[38]).Range.Text = a37.Text;
            doc.Bookmarks.get_Item(ref MyBM[39]).Range.Text = a38.Text;
            doc.Bookmarks.get_Item(ref MyBM[40]).Range.Text = a39.Text;
            doc.Bookmarks.get_Item(ref MyBM[41]).Range.Text = a40.Text;
            doc.Bookmarks.get_Item(ref MyBM[42]).Range.Text = a41.Text;
            doc.Bookmarks.get_Item(ref MyBM[43]).Range.Text = a42.Text;
            doc.Bookmarks.get_Item(ref MyBM[44]).Range.Text = a43.Text;
            doc.Bookmarks.get_Item(ref MyBM[45]).Range.Text = a44.Text;
            doc.Bookmarks.get_Item(ref MyBM[46]).Range.Text = a45.Text;
            doc.Bookmarks.get_Item(ref MyBM[47]).Range.Text = a46.Text;
            doc.Bookmarks.get_Item(ref MyBM[48]).Range.Text = a47.Text;
            doc.Bookmarks.get_Item(ref MyBM[49]).Range.Text = a48.Text;
            doc.Bookmarks.get_Item(ref MyBM[50]).Range.Text = a49.Text;
            doc.Bookmarks.get_Item(ref MyBM[51]).Range.Text = a50.Text;
            doc.SaveAs(ref aa);
            doc.Close();
            this.Enabled = true;
        }
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            if (MyData.Tables[0].Rows.Count >= 1)
            {
                ...
                OleDbDataAdapter MyAd0 = new OleDbDataAdapter("select top 1 * from e62zqbg order by a0 desc", MyConn);
        ...
        {
            Process.Start(".\\" + main.companyName + "\\wjgl\\562");
        }
        ...
        public void CleanApp()
        {
            ...
            //内存数据删除
            ((DataSet)_562_f.MyData_delete).Tables[0].Rows.RemoveAt(_562_f.i);


            // int a =;// 数据库删除
            string SQL = "delete * from e62zqbg where a0='" + ((TextBox)_562_f.text_a0).Text + "'";
            OleDbCommand NewCom = new OleDbCommand(SQL, _562_f.MyConn);
            ...
            if (File.Exists(@".\\" + main.companyName + "\\wjgl\\562\\" + ((TextBox)_562_f.text_a0).Text + "\\" + ((TextBox)_562_f.text_a0).Text + ".docx"))
            {
                // MessageBox.Show("存在文件");
                File.Delete(@".\\" + main.companyName + "\\wjgl\\562\\" + ((TextBox)_562_f.text_a0).Text + "\\" + ((TextBox)_562_f.text_a0).Text + ".docx");

            }

            if (Directory.Exists(@".\\" + main.companyName + "\\wjgl\\562\\" + ((TextBox)_562_f.text_a0).Text + ""))
            {
                // MessageBox.Show("存在文件夹");
                Directory.Delete(@".\\" + main.companyName + "\\wjgl\\562\\" + ((TextBox)_562_f.text_a0).Text + "");
            }
