...
namespace MyApp
{
    public partial class _201_f : Form,FormFather
    {
        /*
  * 查询数据块-
  */
         ...
         * * -查询数据块
        */
        private string DB_table_name = "bsbyy1";
        public  object text_a0;//传A0的值
        private string FormId="201";
        //数据库链接
        ...
        public _201_f()
        {
            ...
            MyConn.Open();
            MyAd = new OleDbDataAdapter("select *  from bsbyy1 ", MyConn);
            MyAd.Fill(MyData);
            objCommandBuilder = new OleDbCommandBuilder(MyAd);
            Directory.CreateDirectory(".\\" + main.companyName + "\\wjgl\\201");
        ...
        private void _201_f_Load(object sender, EventArgs e)
        {
            ...
            if (MyData.Tables[0].Rows.Count >= 1)
            {
                ...
                a12.Text = MyData.Tables[0].Rows[i][12].ToString();//可选择框
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            if (MyData.Tables[0].Rows.Count == 0)
                a0.Text = (20100001).ToString();
            else
            {
      
                OleDbDataAdapter MyAd00 = new OleDbDataAdapter("select a0  from bsbyy1 order by a0 desc ", MyConn);
        ...
        {
            Process.Start(".\\" + main.companyName + "\\wjgl\\201");
        }
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            for (int v = 0; v < MyData.Tables[0].Rows.Count; v++)
            {
                ...
                if (this.a0.Text == MyData.Tables[0].Rows[v][0].ToString())
                {
                    ...
                    string SQL = "delete from bsbyy1 where a0= '" + this.a0.Text + "'";
            ...
            */
            ...
            OleDbDataAdapter MyAd0 = new OleDbDataAdapter("select count(a0)  from bsbyy1 ", MyConn);
        ...
        {
            OleDbDataAdapter MyAd0 = new OleDbDataAdapter("select *  from bsbyy1 ", MyConn);
            DataSet MyData0 = new DataSet();
      ...
      public  void CleanApp()
        {
            ...
            // int a =;// 数据库删除
            string SQL = "delete * from bsbyy1 where a0='" + ((TextBox)text_a0).Text + "'";
            ...
            if (File.Exists(@".\\" + main.companyName + "\\wjgl\\201\\" + ((TextBox)text_a0).Text + "\\" + ((TextBox)text_a0).Text + ".docx"))
            {
                // MessageBox.Show("存在文件");
                File.Delete(@".\\" + main.companyName + "\\wjgl\\201\\" + ((TextBox)text_a0).Text + "\\" + ((TextBox)text_a0).Text + ".docx");

            }

            if (Directory.Exists(@".\\" + main.companyName + "\\wjgl\\201\\" + ((TextBox)text_a0).Text + ""))
            {
                // MessageBox.Show("存在文件夹");
                Directory.Delete(@".\\" + main.companyName + "\\wjgl\\201\\" + ((TextBox)text_a0).Text + "");
            }
