...
namespace MyApp
{
    public partial class _523_f : Form,FormFather
    {
        /*
         * 查询数据块-
         */
         ...
         * -查询数据块
         */
        private string DB_table_name = "e23bgdl"; 
        public  object text_a0;//传A0的值
        private string FormId="523";
        //数据库链接
        ...
        public _523_f()
        {
            ...
            MyConn.Open();
            MyAd = new OleDbDataAdapter("select *  from e23bgdl ", MyConn);
            MyAd.Fill(MyData);
            objCommandBuilder = new OleDbCommandBuilder(MyAd);
            Directory.CreateDirectory(".\\" + main.companyName + "\\wjgl\\523");
        ...
        private void _523_f_Load(object sender, EventArgs e)
        {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            if (MyData.Tables[0].Rows.Count == 0)
                a0.Text = (52300001).ToString();
            else
            {
             
                OleDbDataAdapter MyAd00 = new OleDbDataAdapter("select a0  from e23bgdl order by a0 desc ", MyConn);
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            for (int v = 0; v < MyData.Tables[0].Rows.Count; v++)
            {
                ...
                if (this.a0.Text == MyData.Tables[0].Rows[v][0].ToString())
                {
                    ...
                    string SQL = "delete from e23bgdl where a0= '" + this.a0.Text + "'";
        ...
        private void save()
        {
            ...
            Directory.CreateDirectory(".\\" + main.companyName + "\\wjgl\\523\\" + a0.Text + "");

            string temp = System.IO.Directory.GetCurrentDirectory();// d当前运行路径

            //    MessageBox.Show(temp);
            string OrignFile;//word模板路径
            OrignFile = "\\baseDB\\商标书式\\3 续展变更转让许可质押注销\\2变更\\3变更商标代理人文件接收人申请书.dot";
            ...
            object aa = temp + "\\" + main.companyName + "\\wjgl\\523\\" + a0.Text + "\\" + a0.Text + ".docx";
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            if (MyData.Tables[0].Rows.Count >= 1)
            {
                ...
                OleDbDataAdapter MyAd0 = new OleDbDataAdapter("select top 1 * from e23bgdl order by a0 desc", MyConn);
                DataSet MyData0 = new DataSet();
                MyAd0.Fill(MyData0);
        ...
        {
            OleDbDataAdapter MyAd0 = new OleDbDataAdapter("select *  from e23bgdl", MyConn);
            DataSet MyData0 = new DataSet();
        ...
        {
            Process.Start(".\\" + main.companyName + "\\wjgl\\523");
        }
       ...
       public void CleanApp()
        {
            ...
            // int a =;// 数据库删除
            string SQL = "delete * from e23bgdl where a0='" + ((TextBox)text_a0).Text + "'";
            ...
            if (File.Exists(@".\\" + main.companyName + "\\wjgl\\523\\" + ((TextBox)text_a0).Text + "\\" + ((TextBox)text_a0).Text + ".docx"))
            {
                // MessageBox.Show("存在文件");
                File.Delete(@".\\" + main.companyName + "\\wjgl\\523\\" + ((TextBox)text_a0).Text + "\\" + ((TextBox)text_a0).Text + ".docx");

            }

            if (Directory.Exists(@".\\" + main.companyName + "\\wjgl\\523\\" + ((TextBox)text_a0).Text + ""))
            {
                // MessageBox.Show("存在文件夹");
                Directory.Delete(@".\\" + main.companyName + "\\wjgl\\523\\" + ((TextBox)text_a0).Text + "");
            }
